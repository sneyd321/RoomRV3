...
void main() {
  ...
  testWidgets("amount_IS_UPDATED_WHEN_RentDiscount_IS_Updated", (tester) async {
    RentDiscount rentDiscount = CustomRentDiscount("", "");
    Widget formField = TextFormField(
        ...
        validator: (String? value) {
          return rentDiscount.updateAmount(value!);
        },
    ...
    await tester.tap(find.text("Test"));
    await tester.pump();
    expect(rentDiscount.amount, "200.00");
  });

  testWidgets("name_IS_UPDATED_WHEN_RentDiscount_IS_Updated", (tester) async {
    RentDiscount rentDiscount = CustomRentDiscount("", "");
    Widget formField = SimpleFormField(
        ...
        onSaved: (value) {},
        onValidate: (value) {
          return rentDiscount.updateName(value!);
        });
    await tester.pumpWidget(getForm(formField));

    await submit(tester, "Example");
    expect(rentDiscount.name, "Example");
  });

  testWidgets("List_of_Detail_IS_UPDATED_WHEN_RentDiscount_IS_Added",
      (tester) async {
    RentDiscount rentDiscount = CustomRentDiscount("", "");
    await tester.pumpWidget(getForm(RentDiscountDetailsList(
  ...
  testWidgets("List_of_Detail_IS_UPDATED_WHEN_RentDiscount_IS_Removed",
      (tester) async {
    RentDiscount rentDiscount = CustomRentDiscount("", "");
    await tester.pumpWidget(getForm(RentDiscountDetailsList(
      rentDiscount: rentDiscount,
  ...
  testWidgets(
      "Please_enter_an_amount_IS_RETURNED_WHEN_RentDiscount_IS_Error-Invalid_Request",
      (tester) async {
    RentDiscount rentDiscount = CustomRentDiscount("", "");
    Widget formField = TextFormField(
        controller: TextEditingController(),
  ...
  testWidgets(
      "Please_enter_a_valid_amount_IS_RETURNED_WHEN_RentDiscount_IS_Error-Invalid_Request",
      (tester) async {
    RentDiscount rentDiscount = CustomRentDiscount("", "");
    Widget formField = TextFormField(
        controller: TextEditingController(),
  ...
  testWidgets(
      "Please_enter_a_name_IS_RETURNED_WHEN_RentDiscount_IS_Error-Invalid_Request",
      (tester) async {
    RentDiscount rentDiscount = CustomRentDiscount("", "");
    Widget formField = SimpleFormField(
        label: "label",
  ...
  testWidgets(
    ...
    await tester.pumpWidget(getForm(RentDiscountDetailsList(rentDiscount: rentDiscount)));
  ...
  testWidgets(
    ...
    await addItemToList(tester, "Parking");
    await addItemToList(tester, "Parking");
    expect(rentDiscount.details.length, 1);
  });
