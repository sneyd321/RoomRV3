...
class _InviteTenantNotificationCardState
  ...
  void showTenantDialog() {
    ...
    tenant.updateFirstName(widget.document["sender"]["firstName"]);
    tenant.updateLastName(widget.document["sender"]["lastName"]);
    tenant.updateEmail(widget.document["sender"]["email"]);
    showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
